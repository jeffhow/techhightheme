        ...
        <div class="container-fluid">
          <h1>
            <a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand" rel="home">
              <span class="d-none d-lg-block d-xl-block">Worcester Technical High School</span>
              <span class="d-block d-lg-none d-xl-none"><span class="d-none">(</span> Worcester Tech<span class="d-none">)</span></span>
            </a>
          </h1>
          <button class="menu-btn navbar-toggler" type="button" data-toggle="collapse" data-target="#primaryNav" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
